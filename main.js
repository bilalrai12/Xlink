  ...
  async makeRequest(
    ...
    do {
      try {
        ...
        if (error.status == 400) {
          this.log(`Invalid request for ${url}, maybe have new update from server | contact: https://t.me/Bilalstudio2 to get new update!`, "error");
          process.exit(0);
        }
...
async function main() {
  console.log(colors.yellow("Telegram channel Link : https://t.me/Bilalstudio2"));
